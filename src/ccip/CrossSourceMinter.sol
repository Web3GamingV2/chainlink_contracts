...
// Use address of CrossChainMinter.sol deployed on Sepolia in contructor
// Call the function mintOnSepolia() to mint a nft in sepolia
...
contract CrossSourceMinter {
    ...
    constructor(address destMinterAddress) {
        ...
        // from Fuji
        address routerAddressFuji = 0x9C32fCB86BF0f4a1A8921a9Fe46de3198bb884B2;
