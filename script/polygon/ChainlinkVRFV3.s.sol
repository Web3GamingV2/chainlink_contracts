...
import {ChainlinkVRFV3} from "../../src/ChainlinkVRFV3.sol";

// forge script script/polygon/ChainlinkVRFV3.s.sol:SubscriptionConsumerV3Script --rpc-url https://polygon-amoy.g.alchemy.com/v2/vkZ5WPCV0qB9Gye9sajMsn9YhdSl7Shy --private-key $WEB3GAMING_PRIVATE_KEY --broadcast --verify --etherscan-api-key 3B5VHH6EPJ17CQGFIHDT3BU5V4UNHIEVQB
...
contract SubscriptionConsumerV3Script is Script {
    function run() public {
     // 获取部署者私钥
        ...
        Upgrades.upgradeProxy(
            proxyAddress,
            "ChainlinkVRFV3.sol:ChainlinkVRFV3",
            ""
        );

        console.log("ChainlinkVRF Proxy deployed to:", proxyAddress);
        ...
        console.log("ChainlinkVRF Owner set to:", deployerAddress);
